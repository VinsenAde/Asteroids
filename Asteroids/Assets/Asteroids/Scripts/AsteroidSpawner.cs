...
namespace Scripts
{
    ...
    public class AsteroidSpawner : MonoBehaviour
    {
        ...
        [Header("Asteroid Physics")] [SerializeField]
        private float pushForce = 50000f;

        [SerializeField] private float angularVelocity = 0.25f;

        [Header("Asteroid Spawning")] [SerializeField]
        private AsteroidData asteroidToSpawn;

        [SerializeField] private int minInitialAsteroids = 2;
        [SerializeField] private int maxInitialAsteroids = 3;
        ...
        private void SpawnAsteroids()
        {
            ...
            for (int i = 0; i < spawnedLastCount; i++)
            {
                ...
                Vector3 randomPositionOnScreenBorder = Camera.main.ViewportToWorldPoint(new Vector3(randomXPos,
                    randomYPos, Mathf.Abs(transform.position.z - Camera.main.transform.position.z)));
