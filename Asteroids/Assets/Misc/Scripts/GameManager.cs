...
namespace Script
{
    public class GameManager : MonoBehaviour
    {
        ...
        [Header("Tags")] [SerializeField] private string playerTag = "Player";
        ...
        [SerializeField] private string playerShipBrokenTag = "PlayerShipBroken";
        [SerializeField] private string shipModuleTag = "ShipModule";
